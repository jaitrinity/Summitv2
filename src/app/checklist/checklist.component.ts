...
export class ChecklistComponent implements OnInit {
  ...
  // }
    ...
    // }
    // else{
    //   verifierRole = this.editableSelectedVerifierRoleList.length == 0 ? "" : CommonFunction.createCommaSeprateByParamDesc(this.editableSelectedVerifierRoleList);
    //   approvalRole = this.editableSelectedApproverRoleList.length == 0 ? "" : CommonFunction.createCommaSeprateByParamDesc(this.editableSelectedApproverRoleList);
    // }
